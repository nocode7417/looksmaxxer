...
class BaselineTab extends ConsumerWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            if (!hasBaseline)
              ...
              // Cultural disclaimer
              _buildMeasurementDisclaimer(ref)
                  .animate()
  ...
  Widget _buildMeasurementDisclaimer(WidgetRef ref) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.sm),
          Text(
            'These measurements are based on objective geometry, not attractiveness judgments. '
            'Facial proportions vary naturally across individuals and populations. '
            'All variations are normal - there is no "ideal" face.',
          ...
          const SizedBox(height: AppSpacing.sm),
          Text(
            'Confidence scores indicate measurement reliability, not quality.',
            style: AppTypography.caption.copyWith(
              color: AppColors.textTertiary,
