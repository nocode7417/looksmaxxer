...
class PoseValidation {
  ...
  /// Aliases for euler angles
  double get pitch => headEulerAngleX;
  double get yaw => headEulerAngleY;
  double get roll => headEulerAngleZ;
...
class LightingValidation {
  ...
  /// Asymmetry as percentage (0-100)
  double get asymmetryPercent => asymmetry * 100;
...
class QualityGateResult {
  ...
  /// Create a result where all quality gates pass (for mock/fallback)
  factory QualityGateResult.allPassed() {
    return QualityGateResult(
      passed: true,
      faceSize: FaceSizeValidation(
        passed: true,
      ...
      lighting: LightingValidation(
        passed: true,
        leftCheekBrightness: 128,
        rightCheekBrightness: 128,
        asymmetry: 0,
      ),
      faceDetected: true,
      failureReasons: [],
